...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Beforerr"
    user-mail-address "zzj956959688@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/zijin/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/zijin/bin" "/profile/bin" "/Users/zijin/.npm-packages/bin" "/Users/zijin/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
